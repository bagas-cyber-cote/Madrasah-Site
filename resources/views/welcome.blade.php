    ...
    <section
        ...
        <div class="relative z-10 mx-auto max-w-7xl px-6">
            ...
            <div class="mb-20 text-center">
                ...
                <p class="mx-auto mt-6 max-w-3xl text-lg leading-8 text-zinc-300 text-justify">
                    Yayasan Pendidikan dan Sosial Hidayaturrahman Nahdlatul Wathan
                    Diniyah Islamiyah Menggala merupakan lembaga pendidikan yang berkomitmen
            ...
            <div class="grid items-center gap-16 lg:grid-cols-2">
                ...
                <div
                    ...
                    <p
                        class="mt-6 leading-9 text-zinc-300 text-justify">
                        Yayasan Pendidikan dan Sosial Hidayaturrahman Nahdlatul Wathan
                    ...
                    <div class="grid items-center gap-12 lg:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p
                                ...
                                Ketua Yayasan PSH NWDI Menggala
                            </p>
                            <p
                                class="mt-8 leading-9 text-zinc-300 text-justify">
                                Beliau memimpin Yayasan Pendidikan dan Sosial 
                                Hidayaturrahman NWDI Menggala dengan visi 
